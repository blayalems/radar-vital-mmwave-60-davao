 ...
 *
 * Firmware release: v16.5.7
 * CSV schema release: v15.2.0 / trainer contract v12.0.0
 *
* Manuscript-facing calibration / release notes
* -------------------------------------------
* + FW_VERSION is v16.5.7.
* + v16.5.7 keeps the v15 serial DATA telemetry prefix and the
...
#error "radar_vital_v16_5_7.ino must be built for esp32:esp32:XIAO_ESP32C6"
#endif
