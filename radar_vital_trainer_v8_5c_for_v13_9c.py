...
<title>Radar Vital Trainer Live Dashboard - v13.9c / v8.5c Publish-Readiness + Minimum-N Policy</title>
      ...
      <div class="row">
        <div class="brand">
          ...
          <div>
            ...
            <div class="subtitle">v13.9c / v8.5c dashboard with publish-readiness hardening, drift brake telemetry, and minimum-n analysis policy</div>
          </div>
        </div>
...
for _dashboard_candidate in _dashboard_template_candidates():
    if _dashboard_candidate.exists():
        try:
            ...
            pass
_DASHBOARD_TEMPLATE_EMBEDDED = _DASHBOARD_TEMPLATE_EMBEDDED.replace("v13.8.0 / v8.4.0", "v13.9c / v8.5c")
