"""radar_vital_trainer_v8_5b_for_v13_9b.py — v8.5b
=====================================================
...
Change highlights
────────────────
  • v13.9b telemetry contract: first-lock / first-anchor protection, AGC gain-floor recovery.
  • near-field reflector guard for AGC, establishing more stable vital sign capture.
  ...
  • dashboard loader prefers an external v8.5b HTML template when present

Primary workflow
────────────────
  1.  python radar_vital_trainer_v8_5b_for_v13_9b.py doctor
  2.  python radar_vital_trainer_v8_5b_for_v13_9b.py quickstart

  Per session (single command):
      python radar_vital_trainer_v8_5b_for_v13_9b.py session \
        --port COM10 \
...
for _dashboard_candidate in _dashboard_template_candidates():
    if _dashboard_candidate.exists():
        try:
            ...
            pass
_DASHBOARD_TEMPLATE_EMBEDDED = _DASHBOARD_TEMPLATE_EMBEDDED.replace("v13.8.0 / v8.4.0", "v13.9b / v8.5b")
