...
| History shows `0s`, missing subject, or undated rows | Old session manifest lacks metadata | Use the PR71+ trainer; it infers timestamp/duration/subject from session files and subject profiles. |
