...
- **CI EXE toolchain**: Pinned the Tauri Windows and release-artifact workflows to Rust 1.94.1 after Rust 1.95 rejected `tauri-utils` 2.9.2 with an upstream coherence conflict in the Windows packaging job.
