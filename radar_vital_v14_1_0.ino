...
#define FW_VERSION "v14.1.0"
#define SKETCH_VERSION_MAJOR 14
...
void loop() {
  ...
  if (calibrationDone) {
    ...
    if (now-lastLogMs>=LOG_INTERVAL_MS) {
      ...
      // CSV column count widened for v13.9.7 truthfulness / RR-ready split / raw-disagree audit telemetry.
      // Expected DATA payload column count after the DATA, prefix: 199. Update this comment whenever columns are added or removed.
      #define CSV_COLUMN_COUNT 199
...
Serial.println((int)hrRawDisagreeRrHarmonicKLogged);
