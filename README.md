...
- **Firmware readback**: `radar_vital_v16_5_7.ino` passively polls the MR60BHA2 module firmware version immediately after `mmWave.begin()` and after radar recovery, so captures can populate `module_fw_*` / `module_fw_valid`.
...
```
.
├── radar_vital_v16_5_7.ino                          # firmware (v16.5.7; v15.2 222-column USB contract, BLE gated off)
