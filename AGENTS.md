...
5. **No new framework.** Vanilla HTML/JS/CSS. No React, Vue, Svelte, Tailwind. Chart.js, Hammer.js, jsqr are the only runtime libraries; all are self-hosted under `assets/lib/`. (NOT ANYMORE APPLICABLE AS OF 5/23/2026).
